...
class GBTScraper():
	...
	def __init__(self,date=None,days=5):
	...
	def __utc2pst__(self,date,wctime):
		input_str = '{0} {1} UTC'.format(date,wctime)
		format_str = '%Y-%m-%d %H:%M'
		utcTime = time.strptime(input_str,format_str+' %Z')
		pstTime = time.localtime(calendar.timegm(utcTime))
